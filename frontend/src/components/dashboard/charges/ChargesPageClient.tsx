...
export default function ChargesPageClient() {
  ...
  return <div className="space-y-5">
    ...
    <div className={`${cardBase} overflow-hidden`}>
      ...
      <div className="flex items-center justify-between border-b bg-slate-50/40 px-4 py-3"><p className="text-xs font-semibold text-slate-500">{charges.length} écriture(s) trouvée(s)</p><ExportButtons onExportExcel={() => exportToCsv('charges', rows)} onExportPdf={() => exportToPrint('Rapport des charges — SPCR', rows)} /></div>
